...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            datetime(2001, 2, 3, 12, 34, 56, tzinfo=pytz.utc),
            "2001-02-03T12:34:56+00:00",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "2001-02-03T12:34:56-01:00",
            datetime(2001, 2, 3, 13, 34, 56, tzinfo=pytz.utc),
        ),
        (
            "2001-02-03T12:34:56+01:00",
            datetime(2001, 2, 3, 11, 34, 56, tzinfo=pytz.utc),
        ),
